 ...
 *
 */
public class modificarDocCreador extends JFrame implements ActionListener{
	...
	JTextField titulo = new JTextField(15);
   	 ...
   	 */
	public modificarDocCreador(List<CustomPair> list) throws fileNotFoundException {
	   setSize(800, 700);
	   ...
	   mostraDocsCreador = new JButton("MOSTRA TOTS ELS DOCUMENTS");
	   mostraDocsCreador.setBounds(225,95,300,30);
