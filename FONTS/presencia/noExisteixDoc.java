...
/**
 * (Interfície) Classe que ens mostra que no existeix el document
 * 
 * @author prop23-subgrup5
 *
 */
public class noExisteixDoc extends JFrame implements ActionListener{
	JLabel text = new JLabel("No existeix aquest document al sistema");
	JButton enrrere = new JButton("ENRERE");
	/**
	 * Creadora que mostra la interfície
	 * @author prop23-subgrup5
	 *
	 */
	public noExisteixDoc(String titol ,String autor) {
			setSize(500, 200);
