...
/**
 * (Interfície) Classe que ens mostra la confirmació de que s'ha eliminat un usuari
 * @author  prop23-subgrup5
 *
 */

public class mostrarOKeliminatUsuari extends JFrame implements ActionListener{
	JLabel text = new JLabel("Usuari eliminat correctament");
	JButton enrrere = new JButton("ENRERE");
	
	/**
	 * Creadora que mostra la interficie
	 */
	public mostrarOKeliminatUsuari() {
			setSize(500, 200);
