...
/**
 * (Interfície) Classe que ens mostra la confirmació de exportat del document
 * @author  prop23-subgrup5
 *
 */
public class mostraOKexportat extends JFrame implements ActionListener{
	JLabel text = new JLabel("Document exportat correctament");
	JButton enrrere = new JButton("ENRERE");
	
	/**
	 * Creadora que mostra la interficie
	 */
	public mostraOKexportat() {
			setSize(500, 200);
