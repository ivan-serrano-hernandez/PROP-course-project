...
/**
 * (Interfície) Classe que ens mostra la confirmació de que tots els documents han sigut exportats
 * @author prop23-subgrup5
 *
 */
public class totsOKexportats extends JFrame implements ActionListener{
	JLabel text = new JLabel("Documents exportats correctament");
	JButton enrrere = new JButton("ENRERE");
	
	/**
	 * Creadora que mostra la interficie
	 */
	public totsOKexportats() {
			setSize(500, 200);
