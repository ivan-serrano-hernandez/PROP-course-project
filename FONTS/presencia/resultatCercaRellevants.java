...
/**
 * (Interfície) Classe que ens mostra el resultat de la cerca de documents rellevants
 * 
 * @author prop23-subgrup5
 *
 */
public class resultatCercaRellevants extends JFrame implements ActionListener{
	 ...
	 */
	public resultatCercaRellevants(String par, int n, TreeMap <String, Float> resultat) {
        ...
        cabecera1 = new JLabel("Aquests son els "+n+" documents mes rellevants en funcio de la seguent query:");
        cabecera2 = new JLabel("Llista paraules: "+par);
        ...
        add(cabecera2);
       	...
       	JTextArea texto = new JTextArea(15,55);
